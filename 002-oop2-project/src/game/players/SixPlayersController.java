...
public class SixPlayersController {
	...
	@FXML
	public Label label_1 = new Label();
	@FXML
	public Label label_2 = new Label();
	@FXML
	public Label label_3 = new Label();
	@FXML
	public Label label_4 = new Label();
	@FXML
	public Label label_5 = new Label();
	@FXML
	public Label label_6 = new Label();
	...
	private void saveAction(ActionEvent event) throws PersistenceException {
		...
		Player player5 = new Player(Player2.getText());
		Player player6 = new Player(Player2.getText());
		players.add(player1);
		players.add(player2);
		players.add(player3);
		players.add(player4);
