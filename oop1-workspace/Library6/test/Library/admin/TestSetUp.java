...
public class TestSetUp {
	...
	public static Administration testSetUp() {
		...
		DataObject[] objects = admin.getDataObject();
		long counter = 1;
		long ean = (int) (Math.random() * 10000000);

		BookItem[] bookItems = admin.getBookItem();
		...
		MusicItem[] musicItems = admin.getMusicItem();
		...
		FilmItem[] filmItems = admin.getFilmItem();
		...
		JournalItem[] journalItems = admin.getJournalItem();
